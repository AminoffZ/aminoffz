...
>
  ...
  <defs>
    <style>
      ...
      .glow {
        filter: drop-shadow(-16px 32px 28px slateblue);
      }

      #laptop-screen {
        filter: drop-shadow(8px -8px 16px slateblue);
      }
    </style>
  </defs>
  <g class="glow" fill="#bfbfbf">
    <path
